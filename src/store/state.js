...
const state = {
  ...
  /**
   * fileType: 文件类型
   * 1 - 文本内容     2 - 图片   3 - 视频   4 - 文件 pdf doc txt
   */
  chatlist: [{
    id: 1,
    user: {
    ...
    unReadMsgCount: 8, //未读的消息数量
    groupChat: false,  //是否群聊
  },
  {
    id: 2,
    user: {
  ...
  //  群聊
  {
    id: 4,
    user: {
      name: 'Vue、uni-app 技术交流群',
      img: require('@/static/images/group.jpg')
    },
    messages: [
      {
        fileType:1,
